 ...
 */
final class Version20181211123930 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD roles TEXT NOT NULL COLLATE utf8mb4_unicode_ci, DROP roles_id');
    }
}
